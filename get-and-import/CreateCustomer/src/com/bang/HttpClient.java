...
//            obj.sendGet();
    ...
    private void sendPost() throws Exception {
    	...
    	String csvFile = "C:/Users/Thanh/Desktop/rider_20200618 (1).csv";
...
//            System.out.println(arrayCreate.toString());
            ...
            for(int i =0; i<arrayCreate.size();i++){
                ...
                System.out.println(arrayCreate.get(i));
                callAPI(arrayCreate.get(i));
                count++;
                System.out.println(i);
            }
    ...
    private void callAPI(String array) throws Exception {
      URL url = new URL("https://20-dot-dobody-anvui.an.r.appspot.com/company_customer/remove");
